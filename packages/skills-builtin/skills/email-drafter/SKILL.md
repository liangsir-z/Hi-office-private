---
name: email-drafter
description: Draft professional emails for follow-ups, asks, declines, and apologies with tone-by-scenario guidance. Triggers on email, draft email, write email.
when_to_use: When the user asks for help with Draft professional emails for follow-ups, asks, declines, and apologies with tone-by-scenario guidance.
app: docs
