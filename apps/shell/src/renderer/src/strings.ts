...
export const strings = {
  zh: {
    ...
    navStarred: '收藏',
    navSettings: '设置',
    settingsModelSection: '模型与 AI',
    settingsApiKey: 'API Key',
    settingsModel: '模型',
    settingsBaseUrl: 'Base URL',
    settingsImageGen: '图片生成',
    settingsSave: '保存',
    settingsSaved: '已保存',
    settingsLang: '界面语言',
    settingsSkills: '技能',
    settingsOpenSkillsDir: '打开技能目录',
    navCloud: 'Cloud Projects',
    cloudSubtitle: '在网页端用 AI 创建的项目。编辑在浏览器中继续——点击任意项目即可打开。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '刷新',
    cloudLoginHint: '登录 账号，查看你在网页端创建的项目。',
    cloudEmpty: '还没有网页端项目。',
    ...
    loginCopyUrl: '复制登录链接',
    loginCopied: '已复制',
    loginNetworkError: '无法连接服务器,请检查网络或代理设置',
    ...
    onbTitle1: '欢迎使用 Hi-office',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '这只是一个开始',
    onbBody2: 'Hi-office 目前处于 alpha 阶段。欢迎加入 社区，分享反馈，一起塑造它的未来。',
    onbCredits: '活跃贡献者可获得 **1,000+ 积分**',
    onbJoinGenTeam: '加入 Community',
    onbSkip: '跳过',
    onbNext: '下一步',
    onbStart: '开始使用',
  ...
  en: {
    ...
    settingsModelSection: 'Models & AI',
    settingsApiKey: 'API Key',
    settingsModel: 'Model',
    settingsBaseUrl: 'Base URL',
    settingsImageGen: 'Image generation',
    settingsSave: 'Save',
    settingsSaved: 'Saved',
    settingsLang: 'Language',
    settingsSkills: 'Skills',
    settingsOpenSkillsDir: 'Open skills folder',
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Projects created on the web with AI. Editing continues in your browser — click any project to open it.',
    ...
    cloudLoginHint: 'Sign in to your account to see projects you created on the web.',
    ...
    account: 'Account',
    login: 'Sign in',
    serviceSignIn: 'Sign in',
    loggedIn: 'Signed in',
    loggedInService: 'Signed in',
    ...
    loginCopied: 'Copied',
    loginNetworkError: 'Cannot reach the server — check your network or proxy settings',
    ...
    newTab: 'New tab',
    // First-run onboarding
    onbTitle1: 'Welcome to Hi-office',
    ...
    onbBody2:
      'Hi-office is still in alpha. Join the group chat on Community to share feedback and help shape what comes next.',
    onbCredits: 'Active contributors get **1,000+ credits**',
    onbJoinGenTeam: 'Join Community',
    onbSkip: 'Skip',
    onbNext: 'Next',
    ...
    onbNote3: 'AI features may consume credits.',
    onbBack: 'Back',
  },
  ja: {
    // Sidebar navigation
    ...
    navStarred: 'お気に入り',
    navSettings: '設定',
    settingsModelSection: 'モデルと AI',
    settingsApiKey: 'API Key',
    settingsModel: 'モデル',
    settingsBaseUrl: 'Base URL',
    settingsImageGen: '画像生成',
    settingsSave: '保存',
    settingsSaved: '保存しました',
    settingsLang: '言語',
    settingsSkills: 'スキル',
    settingsOpenSkillsDir: 'スキルフォルダーを開く',
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Web で AI を使って作成したプロジェクト。編集はブラウザで続行します。クリックで開きます。',
    ...
    cloudRefresh: '更新',
    cloudLoginHint:
      'Hi-office アカウントにサインインすると、Web で作成したプロジェクトを表示できます。',
    ...
    noContent: '（内容なし）',
    // Account
    accountService: 'Hi-office アカウント',
    account: 'アカウント',
    login: 'サインイン',
    serviceSignIn: 'Hi-office アカウントでサインイン',
    loggedIn: 'サインイン済み',
    loggedInService: 'Hi-office にサインイン済み',
    waitingLogin:
    ...
    loginCopied: 'コピーしました',
    loginNetworkError:
      'Hi-office に接続できません。ネットワークまたはプロキシ設定を確認してください',
    ...
    newTab: '新しいタブ',
    // First-run onboarding
    onbTitle1: 'Hi-office へようこそ',
    onbSubtitle1: '初のオープンソース AI ネイティブ Office スイート',
    onbBody1:
      '文書の作成、表計算、プレゼン作成、PDF のレビュー。あらゆるステップに AI が組み込まれています。',
    onbTitle2: 'これはまだ始まりにすぎません',
    onbBody2:
      'Hi-office はまだアルファ版です。Community のグループチャットに参加して、フィードバックを共有し、今後の開発を一緒に形作りましょう。',
    onbCredits: 'アクティブな貢献者への特典 **1,000+ Hi-office クレジット**',
    onbJoinGenTeam: 'Community に参加',
    onbSkip: 'スキップ',
    onbNext: '次へ',
    onbStart: 'はじめる',
    ...
    onbNote3: 'AI 機能は Hi-office クレジットを消費する場合があります。',
    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    ...
    navStarred: '즐겨찾기',
    navSettings: '설정',
    settingsModelSection: '모델 및 AI',
    settingsApiKey: 'API Key',
    settingsModel: '모델',
    settingsBaseUrl: 'Base URL',
    settingsImageGen: '이미지 생성',
    settingsSave: '저장',
    settingsSaved: '저장됨',
    settingsLang: '언어',
    settingsSkills: '스킬',
    settingsOpenSkillsDir: '스킬 폴더 열기',
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'AI로 웹에서 만든 프로젝트입니다. 편집은 브라우저에서 계속됩니다. 프로젝트를 클릭하면 열립니다.',
    ...
    cloudRefresh: '새로고침',
    cloudLoginHint: 'Hi-office 계정에 로그인하면 웹에서 만든 프로젝트를 볼 수 있습니다.',
    ...
    noContent: '(내용 없음)',
    // Account
    accountService: 'Hi-office 계정',
    account: '계정',
    login: '로그인',
    serviceSignIn: 'Hi-office 계정으로 로그인',
    loggedIn: '로그인됨',
    loggedInService: 'Hi-office에 로그인됨',
    ...
    loginCopied: '복사됨',
    loginNetworkError: 'Hi-office에 연결할 수 없습니다. 네트워크 또는 프록시 설정을 확인하세요',
    ...
    newTab: '새 탭',
    // First-run onboarding
    onbTitle1: 'Hi-office에 오신 것을 환영합니다',
    onbSubtitle1: '최초의 오픈소스 AI 네이티브 오피스 제품군',
    onbBody1:
      '문서 작성, 스프레드시트 제작, 프레젠테이션 생성, PDF 검토. 모든 단계에 AI가 녹아 있습니다.',
    onbTitle2: '이제 시작일 뿐입니다',
    onbBody2:
      'Hi-office는 아직 알파 단계입니다. Community 그룹 채팅에 참여해 피드백을 공유하고 앞으로의 방향을 함께 만들어 가세요.',
    onbCredits: '활발한 기여자를 위한 혜택 **1,000+ Hi-office 크레딧**',
    onbJoinGenTeam: 'Community 참여하기',
    onbSkip: '건너뛰기',
    onbNext: '다음',
    onbStart: '시작하기',
    ...
    onbNote3: 'AI 기능은 Hi-office 크레딧을 소모할 수 있습니다.',
    onbBack: '이전',
  },
  fr: {
    // Sidebar navigation
    ...
    settingsModelSection: 'Modèles et IA',
    settingsApiKey: 'API Key',
    settingsModel: 'Modèle',
    settingsBaseUrl: 'Base URL',
    settingsImageGen: 'Génération d\'images',
    settingsSave: 'Enregistrer',
    settingsSaved: 'Enregistré',
    settingsLang: 'Langue',
    settingsSkills: 'Compétences',
    settingsOpenSkillsDir: 'Ouvrir le dossier des compétences',
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      "Projets créés sur le web avec AI. L'édition continue dans votre navigateur — cliquez sur un projet pour l'ouvrir.",
    ...
    cloudLoginHint:
      'Connectez-vous à votre compte Hi-office pour voir les projets créés sur le web.',
    ...
    noContent: '(vide)',
    // Account
    accountService: 'Compte Hi-office',
    account: 'Compte',
    login: 'Se connecter',
    serviceSignIn: 'Se connecter avec Hi-office',
    loggedIn: 'Connecté',
    loggedInService: 'Connecté à Hi-office',
    waitingLogin:
    ...
    loginCopied: 'Copié',
    loginNetworkError:
      'Impossible de joindre Hi-office — vérifiez votre réseau ou vos paramètres de proxy',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans Hi-office',
    ...
    onbBody2:
      'Hi-office est encore en alpha. Rejoignez la discussion de groupe sur Community pour partager vos retours et façonner la suite.',
    onbCredits: 'Les contributeurs actifs reçoivent **1 000+ crédits Hi-office**',
    onbJoinGenTeam: 'Rejoindre Community',
    onbSkip: 'Passer',
    onbNext: 'Suivant',
    onbStart: 'Commencer',
    ...
    onbNote3: 'Les fonctions IA peuvent consommer des crédits Hi-office.',
    onbBack: 'Retour',
  },
  de: {
    // Sidebar navigation
    ...
    settingsModelSection: 'Modelle & KI',
    settingsApiKey: 'API Key',
    settingsModel: 'Modell',
    settingsBaseUrl: 'Base URL',
    settingsImageGen: 'Bilderzeugung',
    settingsSave: 'Speichern',
    settingsSaved: 'Gespeichert',
    settingsLang: 'Sprache',
    settingsSkills: 'Skills',
    settingsOpenSkillsDir: 'Skill-Ordner öffnen',
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Mit AI im Web erstellte Projekte. Die Bearbeitung läuft im Browser weiter – klicken Sie auf ein Projekt, um es zu öffnen.',
    ...
    cloudLoginHint:
      'Melden Sie sich bei Ihrem Hi-office-Konto an, um Ihre im Web erstellten Projekte zu sehen.',
    ...
    noContent: '(leer)',
    // Account
    accountService: 'Hi-office-Konto',
    account: 'Konto',
    login: 'Anmelden',
    serviceSignIn: 'Mit Hi-office anmelden',
    loggedIn: 'Angemeldet',
    loggedInService: 'Bei Hi-office angemeldet',
    waitingLogin:
    ...
    loginCopied: 'Kopiert',
    loginNetworkError:
      'Hi-office ist nicht erreichbar — prüfen Sie Netzwerk- oder Proxy-Einstellungen',
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei Hi-office',
    ...
    onbBody2:
      'Hi-office ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf Community bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
    onbCredits: 'Aktive Mitwirkende erhalten **1.000+ Hi-office-Guthaben**',
    onbJoinGenTeam: 'Community beitreten',
    ...
    onbNote3: 'KI-Funktionen können Hi-office-Credits verbrauchen.',
    onbBack: 'Zurück',
  },
  es: {
    // Sidebar navigation
    ...
    navSettings: 'Ajustes',
    settingsModelSection: 'Modelos e IA',
    settingsApiKey: 'API Key',
    settingsModel: 'Modelo',
    settingsBaseUrl: 'Base URL',
    settingsImageGen: 'Generación de imágenes',
    settingsSave: 'Guardar',
    settingsSaved: 'Guardado',
    settingsLang: 'Idioma',
    settingsSkills: 'Habilidades',
    settingsOpenSkillsDir: 'Abrir carpeta de habilidades',
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Proyectos creados en la web con AI. La edición continúa en tu navegador: haz clic en un proyecto para abrirlo.',
    ...
    cloudLoginHint:
      'Inicia sesión en tu cuenta de Hi-office para ver los proyectos creados en la web.',
    ...
    noContent: '(vacío)',
    // Account
    accountService: 'Cuenta de Hi-office',
    account: 'Cuenta',
    login: 'Iniciar sesión',
    serviceSignIn: 'Iniciar sesión con Hi-office',
    loggedIn: 'Sesión iniciada',
    loggedInService: 'Sesión iniciada en Hi-office',
    waitingLogin:
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'No se puede conectar con Hi-office — compruebe su red o la configuración del proxy',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a Hi-office',
    ...
    onbBody2:
      'Hi-office aún está en alfa. Únete al chat grupal en Community para compartir comentarios y ayudar a dar forma a lo que viene.',
    onbCredits: 'Los colaboradores activos reciben **1.000+ créditos de Hi-office**',
    onbJoinGenTeam: 'Unirse a Community',
    onbSkip: 'Omitir',
    onbNext: 'Siguiente',
    onbStart: 'Empezar',
    ...
    onbNote3: 'Las funciones de IA pueden consumir créditos de Hi-office.',
    onbBack: 'Atrás',
  },
  th: {
    // Sidebar navigation
    ...
    settingsModelSection: 'โมเดลและ AI',
    settingsApiKey: 'API Key',
    settingsModel: 'โมเดล',
    settingsBaseUrl: 'Base URL',
    settingsImageGen: 'การสร้างภาพ',
    settingsSave: 'บันทึก',
    settingsSaved: 'บันทึกแล้ว',
    settingsLang: 'ภาษา',
    settingsSkills: 'ทักษะ',
    settingsOpenSkillsDir: 'เปิดโฟลเดอร์ทักษะ',
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'โปรเจกต์ที่สร้างบนเว็บด้วย AI แก้ไขต่อได้ในเบราว์เซอร์ — คลิกโปรเจกต์เพื่อเปิด',
    ...
    cloudRefresh: 'รีเฟรช',
    cloudLoginHint: 'ลงชื่อเข้าใช้บัญชี Hi-office เพื่อดูโปรเจกต์ที่คุณสร้างบนเว็บ',
    ...
    // Account
    accountService: 'บัญชี Hi-office',
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    serviceSignIn: 'ลงชื่อเข้าใช้ด้วย Hi-office',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    loggedInService: 'ลงชื่อเข้าใช้ Hi-office แล้ว',
    ...
    loginNetworkError: 'ไม่สามารถเชื่อมต่อ Hi-office ได้ โปรดตรวจสอบเครือข่ายหรือการตั้งค่าพร็อกซี',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ Hi-office',
    ...
    onbBody2:
      'Hi-office ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน Community เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
    onbCredits: 'ผู้มีส่วนร่วมอย่างต่อเนื่องจะได้รับ **เครดิต Hi-office กว่า 1,000**',
    onbJoinGenTeam: 'เข้าร่วม Community',
    onbSkip: 'ข้าม',
    onbNext: 'ถัดไป',
    ...
    onbNote3: 'ฟีเจอร์ AI อาจใช้เครดิต Hi-office',
    onbBack: 'ย้อนกลับ',
  },
  id: {
    // Sidebar navigation
    ...
    settingsModelSection: 'Model & AI',
    settingsApiKey: 'API Key',
    settingsModel: 'Model',
    settingsBaseUrl: 'Base URL',
    settingsImageGen: 'Pembuatan gambar',
    settingsSave: 'Simpan',
    settingsSaved: 'Tersimpan',
    settingsLang: 'Bahasa',
    settingsSkills: 'Keterampilan',
    settingsOpenSkillsDir: 'Buka folder keterampilan',
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Proyek yang dibuat di web dengan AI. Pengeditan berlanjut di browser — klik proyek untuk membukanya.',
    ...
    cloudLoginHint: 'Masuk ke akun Hi-office untuk melihat proyek yang Anda buat di web.',
    ...
    noContent: '(kosong)',
    // Account
    accountService: 'Akun Hi-office',
    account: 'Akun',
    login: 'Masuk',
    serviceSignIn: 'Masuk dengan Hi-office',
    loggedIn: 'Sudah masuk',
    loggedInService: 'Sudah masuk ke Hi-office',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat terhubung ke Hi-office — periksa jaringan atau pengaturan proxy Anda',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di Hi-office',
    ...
    onbBody2:
      'Hi-office masih dalam tahap alpha. Gabung obrolan grup di Community untuk berbagi masukan dan ikut menentukan arah ke depan.',
    onbCredits: 'Kontributor aktif mendapat **1.000+ kredit Hi-office**',
    onbJoinGenTeam: 'Gabung Community',
    onbSkip: 'Lewati',
    onbNext: 'Berikutnya',
    onbStart: 'Mulai',
    ...
    onbNote3: 'Fitur AI dapat menggunakan kredit Hi-office.',
    onbBack: 'Kembali',
  },
  ru: {
    // Sidebar navigation
    ...
    settingsModelSection: 'Модели и ИИ',
    settingsApiKey: 'API Key',
    settingsModel: 'Модель',
    settingsBaseUrl: 'Base URL',
    settingsImageGen: 'Генерация изображений',
    settingsSave: 'Сохранить',
    settingsSaved: 'Сохранено',
    settingsLang: 'Язык',
    settingsSkills: 'Навыки',
    settingsOpenSkillsDir: 'Открыть папку навыков',
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Проекты, созданные в вебе с AI. Редактирование продолжается в браузере — нажмите на проект, чтобы открыть его.',
    ...
    cloudLoginHint: 'Войдите в аккаунт Hi-office, чтобы увидеть проекты, созданные в вебе.',
    ...
    noContent: '(пусто)',
    // Account
    accountService: 'Учётная запись Hi-office',
    account: 'Учётная запись',
    login: 'Войти',
    serviceSignIn: 'Войти через Hi-office',
    loggedIn: 'Вход выполнен',
    loggedInService: 'Выполнен вход в Hi-office',
    ...
    loginNetworkError: 'Не удаётся подключиться к Hi-office — проверьте сеть или настройки прокси',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в Hi-office',
    ...
    onbBody2:
      'Hi-office пока в альфа-версии. Присоединяйтесь к групповому чату в Community, чтобы делиться отзывами и влиять на дальнейшее развитие.',
    onbCredits: 'Активные участники получают **1000+ кредитов Hi-office**',
    onbJoinGenTeam: 'Присоединиться к Community',
    onbSkip: 'Пропустить',
    onbNext: 'Далее',
    onbStart: 'Начать',
    ...
    onbNote3: 'Функции ИИ могут расходовать кредиты Hi-office.',
    onbBack: 'Назад',
  },
  ar: {
    // Sidebar navigation
    ...
    settingsModelSection: 'النماذج والذكاء الاصطناعي',
    settingsApiKey: 'API Key',
    settingsModel: 'النموذج',
    settingsBaseUrl: 'Base URL',
    settingsImageGen: 'توليد الصور',
    settingsSave: 'حفظ',
    settingsSaved: 'تم الحفظ',
    settingsLang: 'اللغة',
    settingsSkills: 'المهارات',
    settingsOpenSkillsDir: 'فتح مجلد المهارات',
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'مشاريع أُنشئت على الويب باستخدام AI. يستمر التحرير في المتصفح — انقر على أي مشروع لفتحه.',
    ...
    cloudRefresh: 'تحديث',
    cloudLoginHint: 'سجّل الدخول إلى حساب Hi-office لعرض المشاريع التي أنشأتها على الويب.',
    ...
    noContent: '(فارغ)',
    // Account
    accountService: 'حساب Hi-office',
    account: 'الحساب',
    login: 'تسجيل الدخول',
    serviceSignIn: 'تسجيل الدخول باستخدام Hi-office',
    loggedIn: 'تم تسجيل الدخول',
    loggedInService: 'تم تسجيل الدخول إلى Hi-office',
    ...
    loginNetworkError: 'تعذّر الاتصال بـ Hi-office — تحقق من الشبكة أو إعدادات الوكيل',
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في Hi-office',
    ...
    onbBody2:
      'لا يزال Hi-office في مرحلة ألفا. انضم إلى الدردشة الجماعية على Community لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
    onbCredits: 'يحصل المساهمون النشطون على **+1,000 من أرصدة Hi-office**',
    onbJoinGenTeam: 'الانضمام إلى Community',
    onbSkip: 'تخطي',
    onbNext: 'التالي',
    onbStart: 'ابدأ الآن',
    ...
    onbNote3: 'قد تستهلك ميزات الذكاء الاصطناعي أرصدة Hi-office.',
    onbBack: 'رجوع',
  },
  pt: {
    navRecent: 'Recentes',
    ...
    settingsModel: 'Modelo',
    settingsBaseUrl: 'Base URL',
    settingsImageGen: 'Geração de imagens',
    settingsSave: 'Salvar',
    settingsSaved: 'Salvo',
    settingsLang: 'Idioma',
    settingsSkills: 'Habilidades',
    settingsOpenSkillsDir: 'Abrir pasta de habilidades',
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Projetos criados na web com o AI. A edição continua no navegador — clique em um projeto para abri-lo.',
    ...
    cloudLoginHint: 'Entre na sua conta Hi-office para ver os projetos criados na web.',
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',
    accountService: 'Conta Hi-office',
    account: 'Conta',
    login: 'Entrar',
    serviceSignIn: 'Entrar com a Hi-office',
    loggedIn: 'Conectado',
    loggedInService: 'Conectado à Hi-office',
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'Não foi possível conectar ao Hi-office — verifique sua rede ou as configurações de proxy',
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao Hi-office',
    ...
    onbBody2:
      'O Hi-office ainda está em alfa. Entre no chat em grupo no Community para compartilhar feedback e ajudar a moldar o que vem a seguir.',
    onbCredits: 'Contribuidores ativos recebem **1.000+ créditos Hi-office**',
    onbJoinGenTeam: 'Entrar no Community',
    onbSkip: 'Pular',
    onbNext: 'Avançar',
    onbStart: 'Começar',
    onbStepAria: 'Página {n} de {total}',
    ...
    onbNote3: 'Os recursos de IA podem consumir créditos Hi-office.',
    onbBack: 'Voltar',
  },
  it: {
    navRecent: 'Recenti',
    ...
    settingsModelSection: 'Modelli e IA',
    settingsApiKey: 'API Key',
    settingsModel: 'Modello',
    settingsBaseUrl: 'Base URL',
    settingsImageGen: 'Generazione di immagini',
    settingsSave: 'Salva',
    settingsSaved: 'Salvato',
    settingsLang: 'Lingua',
    settingsSkills: 'Abilità',
    settingsOpenSkillsDir: 'Apri cartella abilità',
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Progetti creati sul web con AI. La modifica continua nel browser: fai clic su un progetto per aprirlo.',
    ...
    cloudLoginHint: 'Accedi al tuo account Hi-office per vedere i progetti creati sul web.',
    ...
    noContent: '(vuoto)',
    accountService: 'Account Hi-office',
    account: 'Account',
    login: 'Accedi',
    serviceSignIn: 'Accedi con Hi-office',
    loggedIn: 'Accesso effettuato',
    loggedInService: 'Accesso effettuato a Hi-office',
    ...
    loginCopied: 'Copiato',
    loginNetworkError:
      'Impossibile raggiungere Hi-office — controlla la rete o le impostazioni del proxy',
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in Hi-office',
    ...
    onbBody2:
      'Hi-office è ancora in alpha. Unisciti alla chat di gruppo su Community per condividere feedback e contribuire a plasmare il futuro.',
    onbCredits: 'I collaboratori attivi ricevono **1.000+ crediti Hi-office**',
    onbJoinGenTeam: 'Unisciti a Community',
    onbSkip: 'Salta',
    onbNext: 'Avanti',
    onbStart: 'Inizia',
    ...
    onbNote3: 'Le funzioni IA possono consumare crediti Hi-office.',
    onbBack: 'Indietro',
  },
  pl: {
    navRecent: 'Ostatnie',
    ...
    settingsModelSection: 'Modele i AI',
    settingsApiKey: 'API Key',
    settingsModel: 'Model',
    settingsBaseUrl: 'Base URL',
    settingsImageGen: 'Generowanie obrazów',
    settingsSave: 'Zapisz',
    settingsSaved: 'Zapisano',
    settingsLang: 'Język',
    settingsSkills: 'Umiejętności',
    settingsOpenSkillsDir: 'Otwórz folder umiejętności',
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Projekty utworzone w sieci za pomocą AI. Edycja jest kontynuowana w przeglądarce — kliknij projekt, aby go otworzyć.',
    ...
    cloudLoginHint: 'Zaloguj się na konto Hi-office, aby zobaczyć projekty utworzone w sieci.',
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',
    accountService: 'Konto Hi-office',
    account: 'Konto',
    login: 'Zaloguj się',
    serviceSignIn: 'Zaloguj się przez Hi-office',
    loggedIn: 'Zalogowano',
    loggedInService: 'Zalogowano do Hi-office',
    waitingLogin:
    ...
    loginNetworkError: 'Nie można połączyć się z Hi-office — sprawdź sieć lub ustawienia proxy',
    ...
    onbBody2:
      'Hi-office jest wciąż w fazie alfa. Dołącz do czatu grupowego na Community, aby dzielić się opiniami i współtworzyć jego przyszłość.',
    onbCredits: 'Aktywni współtwórcy otrzymują **1000+ kredytów Hi-office**',
    onbJoinGenTeam: 'Dołącz do Community',
    onbSkip: 'Pomiń',
    onbNext: 'Dalej',
    onbStart: 'Rozpocznij',
    ...
    onbNote3: 'Funkcje AI mogą zużywać kredyty Hi-office.',
    onbBack: 'Wstecz',
  },
  nl: {
    navRecent: 'Recent',
    ...
    settingsModelSection: 'Modellen & AI',
    settingsApiKey: 'API Key',
    settingsModel: 'Model',
    settingsBaseUrl: 'Base URL',
    settingsImageGen: 'Afbeeldingen genereren',
    settingsSave: 'Opslaan',
    settingsSaved: 'Opgeslagen',
    settingsLang: 'Taal',
    settingsSkills: 'Vaardigheden',
    settingsOpenSkillsDir: 'Vaardighedenmap openen',
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Projecten gemaakt op het web met AI. Bewerken gaat verder in je browser — klik op een project om het te openen.',
    ...
    cloudLoginHint:
      'Log in op je Hi-office-account om projecten te zien die je op het web hebt gemaakt.',
    ...
    untitled: 'Naamloos',
    noContent: '(leeg)',
    accountService: 'Hi-office-account',
    account: 'Account',
    login: 'Inloggen',
    serviceSignIn: 'Inloggen met Hi-office',
    loggedIn: 'Ingelogd',
    loggedInService: 'Ingelogd bij Hi-office',
    ...
    loginNetworkError: 'Kan Hi-office niet bereiken — controleer uw netwerk of proxyinstellingen',
    ...
    // First-run onboarding
    onbTitle1: 'Welkom bij Hi-office',
    ...
    onbBody2:
      'Hi-office is nog in alfa. Doe mee aan de groepschat op Community om feedback te delen en mee te bepalen wat er komt.',
    onbCredits: 'Actieve bijdragers krijgen **1.000+ Hi-office-credits**',
    onbJoinGenTeam: 'Word lid van Community',
    onbSkip: 'Overslaan',
    onbNext: 'Volgende',
    ...
    onbNote3: 'AI-functies kunnen Hi-office-credits verbruiken.',
    onbBack: 'Terug',
  },
  ms: {
    navRecent: 'Terkini',
    ...
    settingsModel: 'Model',
    settingsBaseUrl: 'Base URL',
    settingsImageGen: 'Penjanaan imej',
    settingsSave: 'Simpan',
    settingsSaved: 'Disimpan',
    settingsLang: 'Bahasa',
    settingsSkills: 'Kemahiran',
    settingsOpenSkillsDir: 'Buka folder kemahiran',
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'Projek yang dicipta di web dengan AI. Penyuntingan diteruskan dalam pelayar — klik projek untuk membukanya.',
    ...
    cloudLoginHint: 'Log masuk ke akaun Hi-office untuk melihat projek yang anda cipta di web.',
    ...
    noContent: '(kosong)',
    accountService: 'Akaun Hi-office',
    account: 'Akaun',
    login: 'Log masuk',
    serviceSignIn: 'Log masuk dengan Hi-office',
    loggedIn: 'Telah log masuk',
    loggedInService: 'Telah log masuk ke Hi-office',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat menyambung ke Hi-office — semak rangkaian atau tetapan proksi anda',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke Hi-office',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'Hi-office masih dalam peringkat alfa. Sertai sembang kumpulan di Community untuk berkongsi maklum balas dan membentuk masa depannya.',
    onbCredits: 'Penyumbang aktif menerima **1,000+ kredit Hi-office**',
    onbJoinGenTeam: 'Sertai Community',
    onbSkip: 'Langkau',
    onbNext: 'Seterusnya',
    onbStart: 'Mula',
    ...
    onbNote3: 'Ciri AI mungkin menggunakan kredit Hi-office.',
    onbBack: 'Kembali',
  },
  he: {
    navRecent: 'אחרונים',
    navStarred: 'מועדפים',
    navSettings: 'הגדרות',
    settingsModelSection: 'מודלים ו-AI',
    settingsApiKey: 'API Key',
    settingsModel: 'מודל',
    settingsBaseUrl: 'Base URL',
    settingsImageGen: 'יצירת תמונות',
    settingsSave: 'שמור',
    settingsSaved: 'נשמר',
    settingsLang: 'שפה',
    settingsSkills: 'מיומנויות',
    settingsOpenSkillsDir: 'פתח תיקיית מיומנויות',
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'פרויקטים שנוצרו באינטרנט עם AI. העריכה נמשכת בדפדפן — לחצו על פרויקט כדי לפתוח אותו.',
    ...
    cloudRefresh: 'רענון',
    cloudLoginHint: 'התחברו לחשבון Hi-office כדי לראות פרויקטים שיצרתם באתר.',
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',
    accountService: 'חשבון Hi-office',
    account: 'חשבון',
    login: 'התחברות',
    serviceSignIn: 'התחברות עם Hi-office',
    loggedIn: 'מחובר',
    loggedInService: 'מחובר ל-Hi-office',
    ...
    loginCopied: 'הועתק',
    loginNetworkError: 'לא ניתן להתחבר ל-Hi-office — בדקו את הרשת או את הגדרות ה-proxy',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-Hi-office',
    ...
    onbBody2:
      'Hi-office עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-Community כדי לשתף משוב ולעזור לעצב את ההמשך.',
    onbCredits: 'תורמים פעילים מקבלים **1,000+ נקודות Hi-office**',
    onbJoinGenTeam: 'הצטרפו ל-Community',
    onbSkip: 'דילוג',
    onbNext: 'הבא',
    onbStart: 'להתחיל',
    ...
    onbNote3: 'תכונות AI עשויות לצרוך קרדיטים של Hi-office.',
    onbBack: 'חזרה',
  },
  hi: {
    navRecent: 'हाल के',
    ...
    settingsModelSection: 'मॉडल और AI',
    settingsApiKey: 'API Key',
    settingsModel: 'मॉडल',
    settingsBaseUrl: 'Base URL',
    settingsImageGen: 'छवि जनरेशन',
    settingsSave: 'सहेजें',
    settingsSaved: 'सहेजा गया',
    settingsLang: 'भाषा',
    settingsSkills: 'स्किल्स',
    settingsOpenSkillsDir: 'स्किल फ़ोल्डर खोलें',
    navCloud: 'Cloud Projects',
    cloudSubtitle:
      'AI के साथ वेब पर बनाए गए प्रोजेक्ट। संपादन ब्राउज़र में जारी रहता है — खोलने के लिए किसी प्रोजेक्ट पर क्लिक करें।',
    ...
    cloudLoginHint: 'वेब पर बनाए गए प्रोजेक्ट देखने के लिए अपने Hi-office खाते में साइन इन करें।',
    ...
    noContent: '(खाली)',
    accountService: 'Hi-office खाता',
    account: 'खाता',
    login: 'साइन इन करें',
    serviceSignIn: 'Hi-office से साइन इन करें',
    loggedIn: 'साइन इन हो गया',
    loggedInService: 'Hi-office में साइन इन है',
    waitingLogin:
    ...
    loginNetworkError: 'Hi-office से कनेक्ट नहीं हो सका — नेटवर्क या प्रॉक्सी सेटिंग जांचें',
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'Hi-office में आपका स्वागत है',
    ...
    onbBody2:
      'Hi-office अभी अल्फ़ा में है। Community पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
    onbCredits: 'सक्रिय योगदानकर्ताओं के लिए **1,000+ Hi-office क्रेडिट**',
    onbJoinGenTeam: 'Community से जुड़ें',
    onbSkip: 'छोड़ें',
    onbNext: 'आगे',
    onbStart: 'शुरू करें',
    ...
    onbNote3: 'AI सुविधाएँ Hi-office क्रेडिट खर्च कर सकती हैं।',
    onbBack: 'वापस',
  },
  'zh-TW': {
    navRecent: '最近',
    navStarred: '收藏',
    navSettings: '設定',
    settingsModelSection: '模型與 AI',
    settingsApiKey: 'API Key',
    settingsModel: '模型',
    settingsBaseUrl: 'Base URL',
    settingsImageGen: '圖片生成',
    settingsSave: '儲存',
    settingsSaved: '已儲存',
    settingsLang: '介面語言',
    settingsSkills: '技能',
    settingsOpenSkillsDir: '開啟技能資料夾',
    navCloud: 'Cloud Projects',
    cloudSubtitle: '在網頁端用 AI 建立的專案。編輯在瀏覽器中繼續——點擊任意專案即可開啟。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '重新整理',
    cloudLoginHint: '登入 Hi-office 帳號，查看你在網頁端建立的專案。',
    cloudEmpty: '還沒有網頁端專案。',
    ...
    untitled: '未命名',
    noContent: '（無內容）',
    accountService: 'Hi-office 帳號',
    account: '帳號',
    login: '登入',
    serviceSignIn: '登入 Hi-office 帳號',
    loggedIn: '已登入',
    loggedInService: '已登入 Hi-office',
    ...
    loginCopyUrl: '複製登入連結',
    loginCopied: '已複製',
    loginNetworkError: '無法連線至 Hi-office，請檢查網路或代理設定',
    ...
    newTab: '新分頁',
    // First-run onboarding
    onbTitle1: '歡迎使用 Hi-office',
    onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
    onbBody1: '建立文件、製作試算表、產生簡報、審閱 PDF。AI 深度融入每個環節。',
    onbTitle2: '這只是一個開始',
    onbBody2: 'Hi-office 目前仍在 alpha 階段。歡迎加入 社区，分享回饋，一起打造它的未來。',
    onbCredits: '活躍貢獻者可獲得 **1,000+ Hi-office 點數**',
    onbJoinGenTeam: '加入 Community',
    onbSkip: '略過',
    onbNext: '下一步',
    onbStart: '開始使用',
    ...
    onbNote3: 'AI 功能可能消耗 Hi-office 點數。',
    onbBack: '上一步',
  },
} as const
