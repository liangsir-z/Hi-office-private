---
name: meeting-notes
description: Capture and organize meeting notes with action items, decisions, and owners. Triggers on meeting notes, meeting summary, action items.
when_to_use: When the user asks for help with Capture and organize meeting notes with action items, decisions, and owners.
app: docs
