...
const tMain = createI18n({
  zh: {
    ...
    menuWindow: '窗口',
    menuHelp: '帮助',
    menuDocsHelp: 'Hi-office Docs 帮助',
  },
  en: {
    ...
    menuWindow: 'Window',
    menuHelp: 'Help',
    menuDocsHelp: 'Hi-office Docs Help',
  },
  ja: {
    dlgOpenDoc: '文書を開く',
    filterWord: 'Word 文書',
    ...
    menuWindow: 'ウィンドウ',
    menuHelp: 'ヘルプ',
    menuDocsHelp: 'Hi-office Docs ヘルプ',
  },
  ko: {
    dlgOpenDoc: '문서 열기',
    filterWord: 'Word 문서',
    ...
    menuWindow: '창',
    menuHelp: '도움말',
    menuDocsHelp: 'Hi-office Docs 도움말',
  },
  fr: {
    ...
    menuWindow: 'Fenêtre',
    menuHelp: 'Aide',
    menuDocsHelp: 'Aide Hi-office Docs',
  },
  de: {
    ...
    menuWindow: 'Fenster',
    menuHelp: 'Hilfe',
    menuDocsHelp: 'Hi-office Docs-Hilfe',
  },
  es: {
    ...
    menuWindow: 'Ventana',
    menuHelp: 'Ayuda',
    menuDocsHelp: 'Ayuda de Hi-office Docs',
  },
  th: {
    ...
    menuWindow: 'หน้าต่าง',
    menuHelp: 'วิธีใช้',
    menuDocsHelp: 'วิธีใช้ Hi-office Docs',
  },
  id: {
    ...
    menuWindow: 'Jendela',
    menuHelp: 'Bantuan',
    menuDocsHelp: 'Bantuan Hi-office Docs',
  },
  ru: {
    ...
    menuWindow: 'Окно',
    menuHelp: 'Справка',
    menuDocsHelp: 'Справка Hi-office Docs',
  },
  ar: {
    ...
    menuWindow: 'نافذة',
    menuHelp: 'تعليمات',
    menuDocsHelp: 'تعليمات Hi-office Docs',
  },
  pt: {
    dlgOpenDoc: 'Abrir Documento',
    ...
    menuWindow: 'Janela',
    menuHelp: 'Ajuda',
    menuDocsHelp: 'Ajuda do Hi-office Docs',
  },
  it: {
    ...
    menuWindow: 'Finestra',
    menuHelp: 'Aiuto',
    menuDocsHelp: 'Guida di Hi-office Docs',
  },
  pl: {
    ...
    menuWindow: 'Okno',
    menuHelp: 'Pomoc',
    menuDocsHelp: 'Pomoc Hi-office Docs',
  },
  nl: {
  ...
  he: {
    ...
    menuWindow: 'חלון',
    menuHelp: 'עזרה',
    menuDocsHelp: 'עזרה של Hi-office Docs',
  },
  hi: {
    ...
    menuWindow: 'विंडो',
    menuHelp: 'सहायता',
    menuDocsHelp: 'Hi-office Docs सहायता',
  },
  'zh-TW': {
    dlgOpenDoc: '開啟文件',
    filterWord: 'Word 文件',
    ...
    menuWindow: '視窗',
    menuHelp: '說明',
    menuDocsHelp: 'Hi-office Docs 說明',
  },
})
...
export function defaultSaveDir(): string {
  const dir = join(app.getPath('documents'), 'Hi-office')
...
export function registerAiIpc(): void {
  ...
  // bundled root: dev → repo packages/skills-builtin/skills; packaged → resourcesPath/skills-builtin
  ...
  // [templates] user template store (extract/save/list/apply/delete)
...
export function startDocsStandalone(): void {
  ...
  // the installed Hi-office Docs is open and forwards its argv there instead.
  if (isDev) app.setPath('userData', join(app.getPath('appData'), 'Hi-office Docs Dev'))
