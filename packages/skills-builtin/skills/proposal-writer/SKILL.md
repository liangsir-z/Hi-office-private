...
description: Draft sales, quote, and partnership proposals with executive summaries, pricing, and CTAs. Triggers on proposal, business proposal, sales proposal.
when_to_use: When the user asks for help with Draft sales, quote, and partnership proposals with executive summaries, pricing, and CTAs.
app: docs
