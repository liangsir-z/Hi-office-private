---
name: html-slides
description: Design slide decks with structure, themes, transitions, and speaker-note rules. Triggers on slides, presentation, slide deck, pitch deck.
when_to_use: When the user asks for help with Design slide decks with structure, themes, transitions, and speaker-note rules.
app: slides
