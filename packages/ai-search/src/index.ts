/**
 * Search utilities (main process) — Serper Google API first, with DuckDuckGo as
 * the last resort. Runs in the main process (Node fetch) to avoid renderer CORS;
 * the Serper key reuses SERPER_API_KEY.
 */
