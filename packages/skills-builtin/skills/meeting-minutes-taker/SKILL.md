...
description: Transform raw meeting transcripts into comprehensive, evidence-based meeting minutes through multi-pass review and speaker identification. Triggers on meeting minutes, transcript summary, convert transcript to notes.
when_to_use: When the user provides a meeting transcript (or asks to convert one) and wants structured minutes with speakers, decisions, and action items.
app: docs
license: MIT (adapted from daymade/claude-code-skills)
---
