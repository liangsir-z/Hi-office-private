...
describe('remoteImageHeaders', () => {
  it('sends no Referer (host-based stamping was removed with the Hi-office CDN)', () => {
    expect(remoteImageHeaders('https://example.com/a.png').Referer).toBeUndefined()
    expect(remoteImageHeaders('https://cdn.stockphoto.com/a.png').Referer).toBeUndefined()
  })
