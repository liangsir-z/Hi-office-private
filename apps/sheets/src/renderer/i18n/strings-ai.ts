...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiAccount: 'Hi-office 账号',
    aiAccountChecking: '检测中…',
    aiLoggedIn: '已登录',
    aiLoggedInAs: '已登录：{email}',
    aiNotLoggedIn: '未登录（AI 功能需要登录 Hi-office 账号）',
    aiWaitingBrowserLogin: '等待浏览器登录…',
    aiSignIn: '登录 Hi-office',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '保存',
    aiUnknownError: '未知错误',
  ...
  en: {
    ...
    aiCloudLoginBtn: 'Sign in to Hi-office',
    ...
    aiAccount: 'Hi-office account',
    aiAccountChecking: 'Checking…',
    aiLoggedIn: 'Signed in',
    aiLoggedInAs: 'Signed in: {email}',
    aiNotLoggedIn: 'Not signed in (AI features require a Hi-office account)',
    aiWaitingBrowserLogin: 'Waiting for browser sign-in…',
    aiSignIn: 'Sign in to Hi-office',
    aiModel: 'Model',
    aiCancel: 'Cancel',
    aiSave: 'Save',
  ...
  ja: {
    ...
    aiCloudLoginBtn: 'Hi-office にサインイン',
    ...
    aiAccount: 'Hi-office アカウント',
    aiAccountChecking: '確認中…',
    aiLoggedIn: 'サインイン済み',
    aiLoggedInAs: 'サインイン済み: {email}',
    aiNotLoggedIn: '未サインイン（AI 機能には Hi-office アカウントへのサインインが必要です）',
    aiWaitingBrowserLogin: 'ブラウザーでのサインインを待機中…',
    aiSignIn: 'Hi-office にサインイン',
    aiModel: 'モデル',
    aiCancel: 'キャンセル',
    aiSave: '保存',
  ...
  ko: {
    ...
    aiAccount: 'Hi-office 계정',
    aiAccountChecking: '확인 중…',
    aiLoggedIn: '로그인됨',
    aiLoggedInAs: '로그인됨: {email}',
    aiNotLoggedIn: '로그인되지 않음(AI 기능을 사용하려면 Hi-office 계정 로그인이 필요합니다)',
    aiWaitingBrowserLogin: '브라우저 로그인 대기 중…',
    aiSignIn: 'Hi-office 로그인',
    aiModel: '모델',
    aiCancel: '취소',
    aiSave: '저장',
  ...
  fr: {
    ...
    aiCloudLoginBtn: 'Se connecter à Hi-office',
    ...
    aiAccount: 'Compte Hi-office',
    aiAccountChecking: 'Vérification…',
    aiLoggedIn: 'Connecté',
    aiLoggedInAs: 'Connecté : {email}',
    aiNotLoggedIn: 'Non connecté (les fonctions IA nécessitent un compte Hi-office)',
    aiWaitingBrowserLogin: 'En attente de la connexion dans le navigateur…',
    aiSignIn: 'Se connecter à Hi-office',
    aiModel: 'Modèle',
    aiCancel: 'Annuler',
    aiSave: 'Enregistrer',
  ...
  de: {
    ...
    aiCloudLoginBtn: 'Bei Hi-office anmelden',
  ...
  es: {
    ...
    aiCloudLoginBtn: 'Iniciar sesión en Hi-office',
  ...
  th: {
    ...
    aiCloudLoginBtn: 'ลงชื่อเข้าใช้ Hi-office',
  ...
  id: {
    ...
    aiCloudLoginBtn: 'Masuk ke Hi-office',
  ...
  ru: {
    ...
    aiCloudLoginBtn: 'Войти в Hi-office',
    ...
    aiAccount: 'Учётная запись Hi-office',
    aiAccountChecking: 'Проверка…',
    aiLoggedIn: 'Вход выполнен',
    aiLoggedInAs: 'Вход выполнен: {email}',
    aiNotLoggedIn: 'Вход не выполнен (для функций ИИ требуется учётная запись Hi-office)',
    aiWaitingBrowserLogin: 'Ожидание входа в браузере…',
    aiSignIn: 'Войти в Hi-office',
    aiModel: 'Модель',
    aiCancel: 'Отмена',
    aiSave: 'Сохранить',
  ...
  ar: {
    ...
    aiCloudLoginBtn: 'تسجيل الدخول إلى Hi-office',
  ...
  pt: {
    ...
    aiCloudLoginBtn: 'Entrar no Hi-office',
  ...
  it: {
    ...
    aiCloudLoginBtn: 'Accedi a Hi-office',
  ...
  pl: {
    ...
    aiCloudLoginBtn: 'Zaloguj się do Hi-office',
  ...
  nl: {
    ...
    aiCloudLoginBtn: 'Aanmelden bij Hi-office',
    ...
    aiNotLoggedIn: 'Niet aangemeld (AI-functies vereisen een Hi-office-account)',
    aiWaitingBrowserLogin: 'Wachten op aanmelding in de browser…',
    aiSignIn: 'Aanmelden bij Hi-office',
    aiModel: 'Model',
    aiCancel: 'Annuleren',
    aiSave: 'Opslaan',
  ...
  ms: {
    ...
    aiCloudLoginBtn: 'Log masuk ke Hi-office',
  ...
  he: {
    ...
    aiCloudLoginBtn: 'התחבר ל-Hi-office',
    ...
    aiAccount: 'חשבון Hi-office',
    aiAccountChecking: 'בודק…',
    aiLoggedIn: 'מחובר',
    aiLoggedInAs: 'מחובר: {email}',
    aiNotLoggedIn: 'לא מחובר (תכונות AI דורשות חשבון Hi-office)',
    aiWaitingBrowserLogin: 'ממתין לכניסה בדפדפן…',
    aiSignIn: 'כניסה ל-Hi-office',
    aiModel: 'מודל',
    aiCancel: 'ביטול',
    aiSave: 'שמירה',
  ...
  hi: {
    ...
    aiCloudLoginBtn: 'Hi-office में साइन इन करें',
  ...
  'zh-TW': {
    ...
    aiAccount: 'Hi-office 帳號',
    aiAccountChecking: '偵測中…',
    aiLoggedIn: '已登入',
    aiLoggedInAs: '已登入：{email}',
    aiNotLoggedIn: '未登入（AI 功能需要登入 Hi-office 帳號）',
    aiWaitingBrowserLogin: '等待瀏覽器登入…',
    aiSignIn: '登入 Hi-office',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '儲存',
    aiUnknownError: '未知錯誤',
