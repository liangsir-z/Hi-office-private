---
name: chart-designer
description: Design charts with a selection decision tree, color palettes (incl. colorblind-safe), and visualization best practices. Triggers on chart, visualization, graph design.
when_to_use: When the user asks for help with Design charts with a selection decision tree, color palettes (incl.
app: sheets
