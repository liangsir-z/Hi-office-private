---
name: resume-tailor
description: Optimize resumes for ATS with power-verb banks, quantified results, and industry keywords. Triggers on resume, CV, tailor resume.
when_to_use: When the user asks for help with Optimize resumes for ATS with power-verb banks, quantified results, and industry keywords.
app: docs
