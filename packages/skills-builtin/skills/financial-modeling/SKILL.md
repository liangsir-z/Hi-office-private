...
description: Build three-statement financial models with driver formulas, DSO/DIO/DPO, and projection tables. Triggers on financial model, three-statement, projection.
when_to_use: When the user asks for help with Build three-statement financial models with driver formulas, DSO/DIO/DPO, and projection tables.
app: sheets
license: MIT (adapted from claude-office-skills/skills)
---
