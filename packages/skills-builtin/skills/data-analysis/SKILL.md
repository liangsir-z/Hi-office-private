---
name: data-analysis
description: Analyze spreadsheet data with chart selection, pivot design, and formula generation. Triggers on data analysis, analyze data, spreadsheet analysis.
when_to_use: When the user asks for help with Analyze spreadsheet data with chart selection, pivot design, and formula generation.
app: sheets
