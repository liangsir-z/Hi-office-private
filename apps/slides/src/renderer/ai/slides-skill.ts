...
const AGENT_SYSTEM_PROMPT = `You are the AI assistant inside Hi-office Slides (a slide editor), helping users improve and generate presentations.
        ...
        plan: {
          ...
          properties: {
            variant: {
              ...
              description:
                'cover pages → cover_typography_hero (pure typography) or cover_split_color (accent panel + image/decor right); 3 parallel points → three_column_cards; one key metric → hero_big_number; pros/cons or before/after → two_column_comparison; text + visual → left_text_right_image; several metrics → kpi_cards_row; a contents/overview page → table_of_contents; chapter/section separator → section_divider; final page → closing_thank_you. Pick the matching structural variant whenever the page type fits — do not hand-nudge a TOC or divider into shape.',
            },
            ...
            items: {
              type: 'array',
              description: 'table_of_contents: numbered entries in order',
              items: {
                type: 'object',
            ...
            sectionNumber: { type: 'string', description: 'section_divider: the big section number (e.g. "02")' },
