---
name: weekly-report
description: Create structured weekly status reports with quantified accomplishments, blockers, and plans. Triggers on weekly report, status update, progress report.
when_to_use: When the user asks for help with Create structured weekly status reports with quantified accomplishments, blockers, and plans.
app: docs
